...
public class MyFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          String Result = connDT.Login(jTextField1.getText(), new String (jPasswordField1.getPassword()));
          
          
          if( Result != null) {
               JOptionPane.showMessageDialog(null, "Login executado com sucesso" + Result);
          } else {
